...
export default function SettingsPage() {
  ...
  const t = ja ? {
    ...
    apiKeyDesc: "AI Guardianプロキシへのリクエスト認証に使用するキーです。AuthorizationヘッダーにBearerトークンとして設定してください。",
    generate: "新しいAPIキーを生成",
    generating: "生成中...",
    keyWarning: "このキーは再表示されません。今すぐコピーしてください。",
    proxyTitle: "プロキシの使い方",
    proxyDesc: "既存のOpenAI base URLをAI Guardianプロキシに置き換えるだけで利用できます：",
    slackTitle: "Slack通知",
    ...
    apiKeyDesc: "Use this key to authenticate requests to the AI Guardian proxy. Pass it as a Bearer token in the Authorization header.",
    generate: "Generate New API Key",
    generating: "Generating...",
    keyWarning: "This key will not be shown again. Copy it now.",
    proxyTitle: "Proxy Usage",
    proxyDesc: "Replace your existing OpenAI base URL with the AI Guardian proxy:",
