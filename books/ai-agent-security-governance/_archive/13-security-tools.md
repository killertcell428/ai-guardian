---
title: "セキュリティツールの導入——AI Guardianとエコシステム"
---

# セキュリティツールの導入——AI Guardianとエコシステム
...
AI Guardianは、AIアプリケーション向けのセキュリティライブラリです。プロンプトインジェクションの検出、機密情報の漏洩防止、コンプライアンス対応を統合的に提供します。
...
AI Guardianは64種類の検出パターンを内蔵しています。
...
| ツール | 特徴 | 用途 |
|--------|------|------|
| **AI Guardian** | 64パターン、日本語対応、軽量 | 汎用的なAIセキュリティ |
