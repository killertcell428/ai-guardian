...
export default function FeaturesSection() {
  ...
  const features = [
    ...
    { mark: "RPT",   title: lang === "ja" ? "コンプライアンスレポート自動生成" : "Compliance Report Auto-Generation", desc: lang === "ja" ? "OWASP LLM Top 10（100%）、SOC2、GDPR、日本AI規制25要件をPDF・Excel・CSVで自動出力。四半期監査に即対応。" : "Auto-generate PDF/Excel/CSV reports covering OWASP LLM Top 10 (100%), SOC2, GDPR, and 25 Japan AI regulations. Audit-ready.", tag: lang === "ja" ? "Business · PDF/Excel" : "Business · PDF/Excel", tagColor: "bg-green-50 text-green-700 border border-green-200" },
