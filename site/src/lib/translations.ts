...
export const t = {
  ...
  howItWorks: {
    ...
    step1Title: {
      ...
      ja: "1行変えるだけ：base URLをAI Guardianに",
    },
    step1Desc: {
      en: "Point your OpenAI SDK's base URL to AI Guardian's proxy endpoint. SDK, request format, and error handling stay the same.",
      ja: "OpenAI SDKのbase URLをAI Guardianのプロキシエンドポイントに換えるだけ。SDK・リクエスト形式・エラーハンドリングは何も変えなくて大丈夫です。",
    },
    step1Aside: { en: "Average setup time: 4 minutes", ja: "平均セットアップ時間：4分" },
    step2Title: {
      en: "AI Guardian scores & routes",
  ...
  testimonials: {
    ...
    q2: {
      en: "Last quarter, prompt injection took our customer-facing chatbot down twice. Since AI Guardian — zero incidents. Edge cases our own rules missed, the HitL queue catches.",
      ja: "先四半期、プロンプトインジェクションで顧客向けチャットボットが2回ダウンしました。AI Guardian導入後はゼロ件。自社ルールでは拾えなかったエッジケースも、HitLキューが対処してくれています。",
    },
    r2: { en: "AI Platform Lead", ja: "AIプラットフォームリード" },
    c2: { en: "SaaS Company · 200 employees", ja: "SaaS企業 · 従業員200名" },
    q3: {
      en: "LLM-first product, so investors and enterprise customers kept asking 'how do you prevent jailbreaks?' Now we just show the AI Guardian dashboard and the conversation ends.",
      ja: "LLMファーストのプロダクトなので、投資家やエンタープライズのお客様から「ジェイルブレイクはどう防いでいるの？」と繰り返し聞かれていました。今は、AI Guardianのダッシュボードを見せるだけで会話が終わります。",
    },
  ...
  pricing: {
    ...
    starter: {
      ...
      price: { en: "$15", ja: "¥2,000" },
      period: { en: "/ user / month", ja: "/ ユーザー / 月" },
      tagline: {
        en: "For small teams getting started with LLM security",
        ja: "LLMセキュリディを始める小規模チーム向け",
      },
      f1: { en: "Up to 10 users", ja: "最大10ユーザー" },
      f2: { en: "30 hours / month meeting transcription", ja: "月30時間の会議文字起こし" },
      f3: { en: "AI-powered secure meeting notes", ja: "AIセキュア議事録" },
      f4: { en: "Basic PII detection & masking", ja: "基本PII検出・マスキング" },
      f5: { en: "90-day data retention", ja: "90日間データ保持" },
      f6: { en: "Email support", ja: "メールサポート" },
      cta: { en: "Start Free Trial", ja: "無料トライアルを開始" },
    },
    business: {
      name: { en: "Business", ja: "Business" },
      price: { en: "$38", ja: "¥5,000" },
      period: { en: "/ user / month", ja: "/ ユーザー / 月" },
      tagline: {
        en: "For growing teams that need decision intelligence",
        ja: "意思決定インテリジェンスが必要な成長チーム向け",
      },
      f1: { en: "Unlimited users", ja: "ユーザー無制限" },
      f2: { en: "Unlimited meeting hours", ja: "会議時間無制限" },
      f3: { en: "Decision tracking & action items", ja: "意思決定追跡・アクションアイテム" },
      f4: { en: "Industry-specific compliance rules", ja: "業界別コンプライアンスルール" },
      f5: { en: "SSO / SAML authentication", ja: "SSO / SAML認証" },
      f6: { en: "1-year data retention", ja: "1年間データ保持" },
      f7: { en: "Priority support (chat + email)", ja: "優先サポート（チャット + メール）" },
    ...
    enterprise: {
      ...
      f2: { en: "Organization knowledge base", ja: "組織ナレッジ基盤" },
      f3: { en: "On-premises / VPC deployment", ja: "オンプレミス / VPC対応" },
      f4: { en: "Custom compliance reports", ja: "カスタムコンプライアンスレポート" },
      f5: { en: "Dedicated CSM & security engineer", ja: "専任CSM・セキュリティエンジニア" },
      f6: { en: "SOC2 / GDPR / HIPAA ready", ja: "SOC2 / GDPR / HIPAA対応" },
      cta: { en: "Contact Sales", ja: "営業に相談する" },
    },
    /* backward-compat aliases used by current PricingSection */
    free: {
      name: { en: "Starter", ja: "Starter" },
      period: { en: "/ user / month", ja: "/ ユーザー / 月" },
      tagline: {
        en: "For small teams getting started with LLM security",
        ja: "LLMセキュリティを始める小規模チーム向け",
      },
      f1: { en: "Up to 10 users", ja: "最大10ユーザー" },
      f2: { en: "30 hours / month meeting transcription", ja: "月30時間の会議文字起こし" },
      f3: { en: "AI-powered secure meeting notes", ja: "AIセキュア議事録" },
    ...
    pro: {
      ...
      f4: { en: "Industry-specific compliance rules", ja: "業界別コンプライアンスルール" },
      f5: { en: "SSO / SAML authentication", ja: "SSO / SAML認証" },
      f6: { en: "Priority support (chat + email)", ja: "優先サポート（チャット + メール）" },
      cta: { en: "Start Business Trial", ja: "Businessトライアルを開始" },
      badge: { en: "Most Popular", ja: "人気No.1" },
    },
  },
  ...
  faq: {
    ...
    a5: {
      en: "Yes. AI Guardian works as a proxy layer — it's compatible with any OpenAI-compatible endpoint including Azure OpenAI, AWS Bedrock (via compatibility layer), and self-hosted models.",
      ja: "はい、対応しています。AI Guardianはプロキシレイヤーとして動作するため、Azure OpenAI、AWS Bedrock（互換レイヤー経由）、セルフホストモデルなど、OpenAI互換のあらゆるエンドポイントで使えます。",
    },
    q6: {
    ...
    a6: {
      en: "Absolutely. Our audit logs are designed for SOC2 evidence collection. Immutable records, CSV export, retention policies, and role-based access controls. Several of our customers cite AI Guardian in their SOC2 evidence packages.",
      ja: "はい、大いに役立ちます。監査ログはSOC2証拠反集向けに設計されています。改ざん不可の記録、CSVエクスポート、保持ポリシー、ロールベースのアクセス制御を備えています。複数のお客様がSOC2証拠パッケージにAI Guardianを引用しています。",
    },
    contactLabel: {
  ...
  footer: {
    ...
    copyright: {
      en: "© 2025 AI Guardian. All rights reserved.",
      ja: "© 2025 AI Guardian. All rights reserved.",
    },
    builtFor: {
