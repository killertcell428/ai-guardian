...
const LEVEL_DEFENSES = [
  ...
  { en: "AI Guardian regex patterns", ja: "AI Guardian正規表現パターン" },
        ...
        <div className="max-w-4xl mx-auto px-4 pt-8 pb-4">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400 text-sm sm:text-base max-w-2xl mx-auto">
              {isJa
                ? "AIが秘密のパスワードを守っています。プロンプトインジェクションで突破できますか？各レベルはAI Guardianの実際の防御機能を使用しています。"
                : "An AI is guarding a secret password. Can you use prompt injection to extract it? Each level uses AI Guardian's real defense features."}
            </p>
          </div>
                    ...
                    <div className="flex justify-start">
                      <div className="max-w-[80%]">
                        ...
                        {msg.scanInfo && (msg.scanInfo.input_scan || msg.scanInfo.output_scan) && (
                          ...
                          >
                            {showScanDetails === i ? "▼" : "▶"}{" "}
                            {isJa ? "AI Guardianスキャン結果を見る" : "View AI Guardian scan results"}
                          </button>
                        )}
          ...
          {completedLevels.size >= MAX_LEVEL && (
            <div className="mt-8 text-center p-6 rounded-2xl bg-gradient-to-r from-purple-900/50 to-guardian-900/50 border border-purple-700">
              ...
              <p className="text-gray-300 mb-4">
                {isJa
                  ? "あなたのAIアプリも同じ攻撃に晒されています。AI Guardianで守りましょう。"
                  : "Your AI apps face these same attacks. Protect them with AI Guardian."}
              </p>
  ...
  return (
    <div className="mt-2 p-3 rounded-lg bg-gray-900/80 border border-gray-700 text-xs space-y-2">
      <h4 className="font-semibold text-guardian-400">
        {isJa ? "AI Guardian スキャン結果" : "AI Guardian Scan Results"}
      </h4>
      ...
      <p className="text-gray-500 italic">
        {isJa
          ? "これらはAI Guardian SDKの実際のスキャン結果です。あなたのアプリにも同じ保護を追加できます。"
          : "These are real AI Guardian SDK scan results. Add the same protection to your apps."}
      </p>
    </div>
  );
}
