  ...
  return (
    <DocsLayout toc={TOC}>
      ...
      <p>
        {ja
          ? "AI Guardian は"
          : "AI Guardian is fully compatible with the"}{" "}
        <code>openai</code>{" "}
        {ja
      ...
      <p>
        {ja
          ? "AI Guardian は標準のOpenAI形式のエラーレスポンスを返します。"
          : "AI Guardian returns standard OpenAI-shaped error responses. Catch"}{" "}
      ...
      <p>
        ...
        {ja ? "をAI Guardianに向けてください：" : "at AI Guardian:"}
      </p>
      <div className="not-prose my-3">
