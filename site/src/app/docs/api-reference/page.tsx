...
export default function ApiReferencePage() {
  ...
  return (
    <DocsLayout toc={TOC}>
      ...
      <p>{ja ? "AI Guardian は2種類の認証方式を使います：" : "AI Guardian uses two authentication mechanisms:"}</p>
      <ul>
        <li>
      ...
      <p>
        {ja
          ? "OpenAI互換のChat Completionsエンドポイントです。OpenAI APIとまったく同じ形式でリクエストを送信します。AI Guardianがリクエストをフィルタリング・ルーティングし、LLMレスポンスまたはエラーを返します。"
