...
[ai-guardian](https://github.com/cto-ai/ai-guardian)では、Mythos Previewで観測された行動パターンに対応する6カテゴリ・28パターンの検知ルールを新たに追加しました。以下は主要カテゴリの実装例です。
...
```python
from ai_guardian.middleware import AnthropicProxy
...
ai-guardianに追加されたMythos時代の全検知パターンを一覧にします。
...
4. ai-guardianなどの入出力スキャンを本番パイプラインに導入する
...
- [ai-guardian — Mythos-Era Detection Patterns](https://github.com/killertcell428/ai-guardian)
