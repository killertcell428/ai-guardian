...
> This document is the official English translation. Japanese original: [../configuration.md](../configuration.md)
...
2. Within the same category, the contribution is capped at **2× the base score** to prevent runaway scores on noisy input.
