...
This document serves as AI Guardian's self-assessment against the AICM control domains, preparing for formal STAR for AI Level 1 submission.
...
| Control | Status | Evidence |
|---------|:------:|----------|
| Privacy impact assessment | Implemented | AI Guardian performs PII detection as a core function, enabling organizations to conduct privacy impact assessments on AI inputs/outputs |
...
This self-assessment demonstrates AI Guardian's alignment with the CSA AI Controls Matrix across all 10 control domains. AI Guardian's zero-dependency, stateless, open-source architecture provides inherent advantages in security, privacy, transparency, and supply chain risk management.

AI Guardian is preparing for formal CSA STAR for AI Level 1 registration.
