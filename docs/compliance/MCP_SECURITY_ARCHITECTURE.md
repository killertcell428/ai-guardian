...
## How AI Guardian Solves This

### Principle: Defense in Depth

AI Guardian doesn't rely on a single detection method. It layers multiple defense strategies:
...
### Scan a single tool
```python
from ai_guardian.scanner import scan_mcp_tool
...
```python
from ai_guardian.scanner import scan_mcp_tools
