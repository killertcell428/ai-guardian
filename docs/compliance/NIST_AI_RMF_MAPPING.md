...
AI Guardian aligns with the NIST AI Risk Management Framework across all four core functions. This document maps AI Guardian's capabilities to the framework's subcategories, demonstrating how the product supports organizations in managing AI risks.

## Alignment Summary

| Function | Subcategories | AI Guardian Support Level |
|----------|:------------:|:-------------------------:|
| **GOVERN** | 6 | Supports |
| **MAP** | 5 | Supports |
| **MEASURE** | 4 | **Direct** |
...
AI Guardian supports the Govern function through its policy engine and configuration framework.

| Subcategory | Description | AI Guardian Capability |
|-------------|-------------|----------------------|
...
AI Guardian supports the Map function by providing comprehensive threat categorization aligned with industry-standard taxonomies.
...
```
AI Guardian Category        → NIST AI RMF Risk Domain
─────────────────────────────────────────────────────
...
AI Guardian directly implements the Measure function through its detection engine and benchmark framework.
...
AI Guardian directly implements the Manage function through its policy engine, remediation system, and integration framework.
...
The following table maps specific NIST AI RMF Playbook actions to AI Guardian features:

| Playbook Action | AI Guardian Feature |
|----------------|-------------------|
...
AI Guardian is designed to **support organizations' compliance** with the NIST AI Risk Management Framework. As the NIST AI RMF is a voluntary framework, there is no formal certification. AI Guardian's alignment is demonstrated through:
...
Organizations using AI Guardian can reference this mapping when documenting their AI RMF compliance posture.
