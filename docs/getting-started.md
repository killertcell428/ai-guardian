...
As of v0.8.0, AI Guardian fully complies with the **AI Business Operator Guidelines v1.2** (published March 31, 2026). All 37 requirements introduced in v1.2 are covered, including AI agent governance, mandatory Human-in-the-Loop, hallucination-driven malfunction prevention, synthetic content controls, and more.
