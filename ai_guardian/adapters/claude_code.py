"""Claude Code Adapter — hooks integration for AI Guardian.
...
# Mapping from Claude Code tool names to AI Guardian action types
TOOL_ACTION_MAP = {
    "Bash": "shell:exec",
    "Read": "file:read",
    "Write": "file:write",
...
"""AI Guardian hook for Claude Code.
...
def main():
    ...
    if decision == "deny":
        reason = f"AI Guardian blocked: {event.policy_rule_id}"
...
def _map_action(tool_name: str) -> str:
    """Map Claude Code tool name to AI Guardian action."""
    action_map = {
        "Bash": "shell:exec",
        "Read": "file:read",
        "Write": "file:write",
...
def install_hooks(project_dir: str = ".") -> None:
    """Install AI Guardian hooks into a Claude Code project.
