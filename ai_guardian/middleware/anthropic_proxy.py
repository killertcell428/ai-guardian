"""Anthropic Claude drop-in proxy wrapper for ai-guardian.
...
try:
    ...
    raise ImportError(
        ...
        "Install it with: pip install 'aig-guardian[anthropic]'"
    ) from e
...
class SecureAnthropic:
    """Drop-in replacement for ``anthropic.Anthropic`` with built-in AI Guardian scanning.
