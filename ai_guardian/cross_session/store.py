...
Stores session summaries as individual JSON files in .ai-guardian/sessions/,
...
class SessionStore:
    ...
    Stores session summaries in .ai-guardian/sessions/ as individual
    JSON files, one per session. Provides querying across sessions.

    Args:
        storage_dir: Directory for session JSON files.
            Defaults to ``.ai-guardian/sessions``.
    """

    def __init__(self, storage_dir: Path | str = ".ai-guardian/sessions") -> None:
