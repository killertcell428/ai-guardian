"""AI Guardian trust badge — embed in your product UI.
...
BADGE_SVG = """<svg xmlns="http://www.w3.org/2000/svg" width="200" height="28" viewBox="0 0 200 28">
  ...
  <text x="32" y="18" font-family="system-ui,-apple-system,sans-serif" font-size="11" font-weight="600" fill="white">Protected by AI Guardian</text>
</svg>"""


def get_badge_svg() -> str:
    """Return the AI Guardian trust badge as an SVG string."""
    return BADGE_SVG
