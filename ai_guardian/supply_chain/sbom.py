...
Usage::
    ...
    from ai_guardian.supply_chain import SBOMGenerator
...
class SBOMGenerator:
    ...
    def scan_mcp_tools(
        ...
        for tool in tools:
            ...
            from ai_guardian.supply_chain.hash_pin import ToolPinManager
    ...
    def save(self, path: Path | str = ".ai-guardian/sbom.json") -> None:
    ...
    def load(self, path: Path | str = ".ai-guardian/sbom.json") -> None:
