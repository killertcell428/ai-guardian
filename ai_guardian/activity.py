...
Log architecture:
  - Local logs: .ai-guardian/logs/ (per-project, per-user visibility)
  - Global logs: ~/.ai-guardian/global/ (cross-project, for audit/CISO)
  - Alert archive: ~/.ai-guardian/alerts/ (permanent, deny/review events only)
...
def _global_dir() -> Path:
    """Get the global AI Guardian directory (~/.ai-guardian/)."""
    return Path.home() / ".ai-guardian"


class ActivityStream:
    """Multi-tier event logging with automatic global aggregation.

    Tier 1: Local logs (.ai-guardian/logs/) — per-project, user-visible
    Tier 2: Global logs (~/.ai-guardian/global/) — cross-project, CISO view
    Tier 3: Alert archive (~/.ai-guardian/alerts/) — permanent knowledge base
