...
Usage::
    ...
    from ai_guardian.safety.loader import load_safety_spec
    from ai_guardian.safety.verifier import SafetyVerifier
...
from ai_guardian.safety.spec import EffectSpec, SafetySpec
...
class SafetyVerifier:
    ...
    def _effect_matches(action: str, target: str, effect: EffectSpec) -> bool:
        ...
        consistent with :mod:`ai_guardian.policy`.
        """
