"""Adversarial Loop — automated attack-defend-improve cycle for AI Guardian.

Runs iterative rounds where:
  1. Red Team generates novel attacks (template + adaptive mutation)
  2. AI Guardian's scanner attempts to detect them
...
class AdversarialLoop:
    ...
    def _scan(self, text: str) -> tuple[int, bool, list[str]]:
        """Run AI Guardian's scanner on text."""
    ...
    def _generate_attacks_for_round(
        ...
        for category in self.categories:
            ...
            from ai_guardian.redteam import _generate_attacks
