...
ASR (Attack Success Rate) tracking, while highlighting AI Guardian's unique
...
(Apache 2.0). No code is copied; the implementation is original to AI Guardian.
"""
...
# Map ai-guardian categories to OWASP LLM Top 10
...
class MonitoringSnapshot:
    ...
    # ai-guardian unique: multi-layer detection stats
...
class SecurityMonitor:
    ...
    def __init__(
        self,
        data_dir: str = ".ai-guardian/monitor",
    ...
    def record_scan(
        ...
        Args:
            scan_result: A ScanResult from ai_guardian.scanner.
    ...
    def snapshot(self, hours: float = 24) -> MonitoringSnapshot:
        ...
        # Detection layer stats (ai-guardian unique)
    ...
    def owasp_scorecard(self) -> dict[str, dict[str, Any]]:
        ...
        Shows which OWASP categories are covered by ai-guardian's patterns,
...
# accessible from ai_guardian.monitor alongside the existing metrics classes.

from ai_guardian.monitor.anomaly import AnomalyAlert, AnomalyDetector  # noqa: E402, F811
from ai_guardian.monitor.baseline import BaselineBuilder, BehaviorProfile  # noqa: E402
from ai_guardian.monitor.containment import (  # noqa: E402
    ContainmentLevel,
    ContainmentManager,
    ContainmentState,
)
from ai_guardian.monitor.drift import DriftAlert, DriftDetector  # noqa: E402
from ai_guardian.monitor.monitor import (  # noqa: E402
    BehavioralMonitor,
    MonitoringReport as BehavioralMonitoringReport,
)
from ai_guardian.monitor.tracker import ActionTracker, TrackedAction  # noqa: E402
