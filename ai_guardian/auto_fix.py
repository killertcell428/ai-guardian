...
Usage::
    ...
    from ai_guardian.auto_fix import apply_proposals, verify_no_regressions
...
def apply_proposals(
    ...
    Args:
        ...
        storage_dir: Directory for learned defense files (default: .ai-guardian/).
