# Show HN: AI Guardian — Open-source LLM security middleware for Python

**Title**: Show HN: AI Guardian – Open-source Python library to protect LLM apps from prompt injection and jailbreaks

**URL**: https://github.com/killertcell428/ai-guardian
...
I built AI Guardian, an open-source Python library that protects LLM applications from common security threats before they reach the model.
...
Docs: https://github.com/killertcell428/ai-guardian/tree/main/docs/en
...
A: Moderations API は有害コンテンツ検出が主で、プロンプトインジェクション（攻撃者がシステムプロンプトを乗っ取る攻撃）は対象外です。また、外部 API なので latency と cost が発生します。AI Guardian はローカルで動き、プロンプトインジェクション特有のパターンを検出します。
