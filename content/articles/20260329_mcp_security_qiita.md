...
AIエージェントの入出力を包括的に監視したい場合、[AI Guardian](https://github.com/killertcell428/ai-guardian)というOSSツールも選択肢の一つです。LLMへの入力・出力をフィルタリング・ログ記録するPythonライブラリで、MCPを使った開発環境でのポリシー適用に活用できます（[PyPI](https://pypi.org/project/aig-guardian/)）。
