# Awesome List Submissions – AI Guardian
...
**PR Title:** Add AI Guardian – open-source LLM prompt injection detection library

**PR Body:**

## Add AI Guardian to LLM Security Tools

Hi maintainers,

I'd like to add **AI Guardian** to the *LLM Security Libraries / Defensive Tools* section.
...
AI Guardian directly addresses the threats catalogued in this list – prompt injection (LLM01), sensitive information disclosure (LLM02), and jailbreaking (LLM04) – making it a natural fit alongside existing detection and mitigation tools. Unlike most alternatives, it provides CWE-classified findings and per-flag remediation hints, giving practitioners actionable output rather than a binary block signal. It is actively maintained, fully open-source (MIT), and installable with zero external dependencies via `pip install aig-guardian`.
...
**PR Title:** Add AI Guardian – LLM prompt injection and jailbreak detection for Python apps

**PR Body:**

## Add AI Guardian to LLM / AI Application Security

Hi maintainers,

Proposing to add **AI Guardian** under the *AI / LLM Application Security* section (or *Input Validation & Sanitization* if no LLM-specific section exists yet).
...
**PR Title:** Add AI Guardian to Safety & Security – open-source guardrails with OWASP LLM Top 10 coverage

**PR Body:**

## Add AI Guardian to the Safety & Security Section

Hi maintainers,

I'd like to add **AI Guardian** to the *Safety, Security & Alignment / Guardrails* section of this list.
