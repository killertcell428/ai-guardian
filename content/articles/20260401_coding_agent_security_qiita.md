...
> **AI Guardian**はPython製のLLMセキュリティライブラリで、64種類の検出パターンでプロンプトインジェクション・PII漏洩・コマンドインジェクションなどを検出します。日本語の攻撃パターンにも対応。
...
5. ✅ LLMガードレール（AI Guardianなど）で入出力を監視
...
- [AI Guardian - LLMセキュリティライブラリ](https://github.com/killertcell428/ai-guardian)
