...
### Introduction Post
Hi everyone! I'm building an open-source LLM security library called AI Guardian (https://github.com/killertcell428/ai-guardian).
...
- **MCP security**: 43% of MCP servers have injection vulnerabilities. I've documented 6 attack surfaces — would love feedback on the taxonomy (https://github.com/killertcell428/ai-guardian/blob/main/docs/compliance/MCP_SECURITY_ARCHITECTURE.md)
...
### Post
Built a security middleware for LangChain apps — AI Guardian
...
### Post
Sharing an open-source LLM security project: AI Guardian
...
### Post
Built an open-source security layer for LLM deployment pipelines: AI Guardian
