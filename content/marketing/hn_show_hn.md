...
Show HN: AI Guardian – Scan MCP tools for poisoning before your AI agent uses them (Python, zero deps)

## Title (Option B — Broader)
Show HN: AI Guardian – 121-pattern LLM security scanner with MCP tool poisoning detection (Python)
...
I built AI Guardian, an open-source Python library that scans LLM inputs, outputs, and MCP tool definitions for security threats. Zero dependencies (stdlib only), installs in one line.
