/**
 * AI Guardian Trust Badge — React Component
 *
 * Drop this into any React/Next.js app to show that it's protected by AI Guardian.
 *
 * Usage:
...
export function AIGuardianBadge({
  variant = "light",
  href = "https://ai-guardian-mauve.vercel.app",
  className = "",
  ...
  return (
    <a
      ...
      title="Protected by AI Guardian — All AI requests are scanned and monitored"
