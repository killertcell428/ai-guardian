"""Pydantic schemas for AI Guardian billing endpoints."""
...
class CheckoutRequest(BaseModel):
    ...
    model_config = {
        "json_schema_extra": {
            "example": {
                "plan": "pro",
                "success_url": "https://app.ai-guardian.dev/dashboard?checkout=success",
                "cancel_url": "https://app.ai-guardian.dev/pricing",
            }
        }
    }
