...
こうした技術的な実装基盤として、筆者はOSSのLLMセキュリティライブラリ **[ai-guardian](https://github.com/killertcell428/ai-guardian)** を開発しています。
...
- [はじめにガイド](https://github.com/killertcell428/ai-guardian/blob/main/docs/getting-started.md)
