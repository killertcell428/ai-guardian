...
def patch_anthropic(monkeypatch):
    ...
    if "ai_guardian.middleware.anthropic_proxy" in sys.modules:
        del sys.modules["ai_guardian.middleware.anthropic_proxy"]
    yield stub
...
class TestSecureAnthropicInputScanning:
    ...
    def test_prompt_injection_blocked(self):
        ...
        from ai_guardian.middleware.anthropic_proxy import GuardianBlockedError
