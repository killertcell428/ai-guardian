"""Tests for ai_guardian.badge module."""

from ai_guardian.badge import BADGE_SVG, get_badge_html, get_badge_svg
...
class TestBadgeSvg:
    ...
    def test_badge_svg_contains_text(self):
        assert "Protected by AI Guardian" in BADGE_SVG
...
class TestGetBadgeHtml:
    def test_default_link(self):
        ...
        assert "ai-guardian-mauve.vercel.app" in html
        assert "</a>" in html
    ...
    def test_accessibility_title(self):
        html = get_badge_html()
        assert 'title="Protected by AI Guardian"' in html
