"""Tests for ai_guardian.supply_chain — supply chain security (Phase 4a).
...
from ai_guardian.supply_chain.verify import _version_in_range
...
class TestSBOMGenerator:
    ...
    def test_scan_python_packages(self):
        """Scan should find at least ai_guardian itself (or pytest)."""
        gen = SBOMGenerator()
...
class TestTopLevelImports:
    """Ensure supply chain types are importable from ai_guardian."""

    def test_import_from_ai_guardian(self):
