# AI Guardian Architecture (v1.3.1)
...
│
└── badge.py                #   "Secured by AI Guardian" badge (SVG)
```
...
```
MCP Server                                    AI Guardian Defense
┌──────────────────────┐
│ tools/list response   │
│                      │
