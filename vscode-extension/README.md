...
- **Right-click → Scan with AI Guardian** — instantly scan any selected text
...
- VS Code 1.85+
- Python 3.10+ with `ai_guardian` installed:
...
4. View results in the **AI Guardian** sidebar panel.
...
|------------------------------|------------|-------------------------------------------------------|
| `aiGuardian.pythonPath`      | `"python"` | Path to Python with ai_guardian installed             |
...
| `aiGuardian.showStatusBar`   | `true`     | Show AI Guardian item in the status bar               |
...
|---------------------------------|-------------------|------------------------------------|
| AI Guardian: Scan with AI Guardian  | —             | Scan selected text                 |
| AI Guardian: Scan File          | —                 | Scan all string literals in file   |
| AI Guardian: Clear Diagnostics  | —                 | Remove all AI Guardian squiggles   |
| AI Guardian: Show Output        | —                 | Open the AI Guardian output channel|
...
To package:
```bash
npm run package    # produces ai-guardian-*.vsix
```
