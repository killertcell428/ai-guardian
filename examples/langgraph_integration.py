"""LangGraph integration example for AI Guardian.
...
Run:
    pip install "aig-guardian" langgraph langchain-openai
...
if __name__ == "__main__":
    print("AI Guardian — LangGraph Integration Examples")
    print("=" * 50)
    print()
    ...
    print()
    print("Install: pip install 'aig-guardian' langgraph")
    print("Docs: https://github.com/killertcell428/ai-guardian/tree/main/docs/en")
